      ...
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "48px", paddingBottom: "48px", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: "14px", lineHeight: 1.7, marginBottom: "24px", maxWidth: "280px" }}>
          ...
          {/* Links */}
          <div>
            <h4 style={{ color: "white", fontWeight: 700, marginBottom: "20px", fontSize: "15px" }}>Navigation</h4>
              ...
              {[
                ...
                <li key={label}>
                  <button
                    ...
                    style={{ background: "none", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.6)", fontSize: "14px", fontFamily: "Rubik, sans-serif", padding: 0, transition: "color 0.2s" }}
          ...
          {/* Services */}
          <div>
            <h4 style={{ color: "white", fontWeight: 700, marginBottom: "20px", fontSize: "15px" }}>Services</h4>
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          {/* Contact */}
          <div>
            <h4 style={{ color: "white", fontWeight: 700, marginBottom: "20px", fontSize: "15px" }}>Contact</h4>
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              {[
                { icon: "📍", text: "Libreville, Gabon" },
                { icon: "📞", text: "+241 065 300 111" },
                { icon: "📧", text: "ndembi.brice@\nbnsupplychainmanagement.com" },
              ].map((c) => (
                <div key={c.icon} style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                  ...
                  <span style={{ fontSize: "13px", lineHeight: 1.6, color: "rgba(255,255,255,0.6)" }}>{c.text}</span>
                </div>
              ))}
            </div>
            <div style={{ marginTop: "20px" }}>
              <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.4)", marginBottom: "8px" }}>Horaires</div>
        ...
        <div style={{ padding: "24px 0", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
          ...
          <div style={{ fontSize: "12px", color: "rgba(255,255,255,0.3)" }}>
            Gérant : Brice NDEMBI | Design : Phild Younouss Toure
          </div>
        </div>
      </div>
    </footer>
